      ...
      <main className="py-5">
        ...
        <div className="container mx-auto flex justify-between border-b py-5">
          <div className="left flex gap-3">
            <button className="relative flex items-center gap-2 rounded-md border bg-indigo-500 py-2 px-4 text-white hover:border-indigo-500 hover:bg-gray-50 hover:text-gray-800">
              Add Employee
              <svg
